                    ...
                    <div class="table-box">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/pages/order-add.jsp'"><i class="fa fa-file-o"></i> 新建</button>
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="sorting_desc sorting_desc_disabled">下单人数</th>
                                <th class="sorting">订单描述</th>
                                <th class="text-center sorting">订单支付途径</th>
                                <th class="text-center sorting">订单状态</th>
                                <th class="text-center sorting">订单产品id</th>
                                <th class="text-center">下单人id</th>
                            ...
                            <c:forEach items="${pageInfo.list}" var="order">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" onclick="location.href='${pageContext.request.contextPath}/orders/findById.do?id=${order.id}'" class="btn bg-olive btn-xs">详情</button>
