								...
								<tbody>
									...
									<c:forEach items="${permissionsList}" var="p">
										<tr>
											...
											<td>${p.id }</td>
											<td>${p.permissionsName }</td>
											<td>${p.url }</td>
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/permissions/findById.do?id=${p.id}" class="btn bg-olive btn-xs">详情</a>
												<a href="${pageContext.request.contextPath}/permissions/deletePermissionsById.do?permissionsId=${p.id}" class="btn bg-olive btn-xs">删除资源权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
